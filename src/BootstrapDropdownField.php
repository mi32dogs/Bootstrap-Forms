...
class BootstrapDropdownField extends BootstrapFormField {
	...
	public function FieldHolder($attributes = array ()) {
		if(!Config::inst()->get(BootstrapForm::class, 'bootstrap_select_included')) {
			...
			Requirements::javascript("showpro/bootstrap-forms: javascript/bootstrap-select/js/bootstrap-select.min.js");
			Requirements::javascript("showpro/bootstrap-forms: javascript/bootstrap-select/js/i18n/defaults-{$current_locale}.js");
			Requirements::css("showpro/bootstrap-forms: javascript/bootstrap-select/css/bootstrap-select.min.css");
		}
